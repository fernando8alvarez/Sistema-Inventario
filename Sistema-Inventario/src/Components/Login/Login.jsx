...
const estilos = {
  ...
  input2:"border-4 border-gray-300 pl-3 py-2 w-full shadow-sm bg-transparent rounded text-lg focus:outline-none focus:border-[#bfff07] placeholder-gray-500 text-white",
  ...
  useEffect(() => {
    if (user[0]) {
      ...
      if (user[0].code === 1002 && dataUser.usuario) {
        //MODAL 1: Usuario o constraseña incorrectos
        Swal.fire({
          title: "Error!",
          text: status,
          icon: "error",
        ...
        //MODAL 2: Inicio de sesion exitoso
        Swal.fire({
      ...
      <div className={estilos.contenedor1}>
        ...
        <form action="#" className="w-auto">
            ...
            <div className={estilos.contenedor2}>
              <div className="flex flex-col">
                ...
                <div className="flex items-center">
                  ...
                  <button
                    onClick={(e) => show(e)}
                    className="abosolute ml-[-38px]"
                  >
                    <img src={eye} alt="ojo" className="w-6" />
                  </button>
                </div>
                {errors.password && (
          ...
          <div className="flex flex-col  w-full">
            {/*----- BOTON REDIRECCION A REGISTRO DE USUARIO -----*/}
            <button
